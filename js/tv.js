...
fetch('https://api.themoviedb.org/3/tv/episode_group/{id}/popular?api_key=41565a1f50edfb3a733f4d787472c625&language=en-US&page=1')
...
.then(data=>{
    ...
    data.results.map((i,j)=>{
        ...
        if(j == 0){
            ...
            if(j == 1){
                main.innerHTML+=`
                    <h2>Assista os melhores desenhos</h2>
