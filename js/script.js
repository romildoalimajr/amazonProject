...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=41565a1f50edfb3a733f4d787472c625&language=en-US&page=1')
...
fetch('https://api.themoviedb.org/3/tv/popular?api_key=41565a1f50edfb3a733f4d787472c625&language=en-US&page=2')
.then(response => response.json())
.then(data=>{
    //console.log(data);
    data.results.map((i,j)=>{
        ...
        if(j == 0){
            ...
            if(j == 1){
                main.innerHTML+=`
                    <h2>Assista as melhores series</h2>
                    <div class="card-movie"><img src="https://image.tmdb.org/t/p/w500`+i.poster_path+`"/></div>
                `;
            }else{
                main.innerHTML+=`
